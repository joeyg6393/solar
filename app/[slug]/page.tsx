          ...
          <div className="container relative py-16 md:py-24">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <a href={`tel:${pageData.ctaPhone.replace(/[^0-9]/g, '')}`} className="btn btn--outline-white btn--large">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div>
                <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6 sticky top-24">
                  ...
                  <a href={`tel:${pageData.ctaPhone.replace(/[^0-9]/g, '')}`} className="btn btn--primary btn--full mb-3">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    Call Now
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="tel:4135550100" className="btn btn--outline btn--large">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  (413) 555-0100
