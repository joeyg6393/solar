...
import { CitationRef, SourcesSection } from '@/components/Citations';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-orange-600/20 text-orange-400 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-semibold">Professional Solar Installers</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
                Power Your Home with <span className="text-orange-500">Clean Solar Energy</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                Save up to 70% on electricity bills<CitationRef id={1} /> with professional solar panel installation in Springfield, MA. Join 1,200+ happy homeowners who&apos;ve made the switch to renewable energy.
              </p>
        ...
        <div className="bg-white/5 backdrop-blur-sm border-t border-white/10">
          <div className="container py-6">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {['Professional Installation', '25-Year Warranty', 'Free Estimates', 'Quality Guaranteed', 'Flexible Financing'].map((badge, i) => (
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Save on Energy Bills</h3>
              <p className="text-gray-600">
                Reduce your electricity costs by up to 70%.<CitationRef id={1} /> Most homeowners save $1,500+ annually with solar energy.<CitationRef id={2} />
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">🏠</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Increase Home Value</h3>
              <p className="text-gray-600">
                Homes with solar panels sell for 4% more on average.<CitationRef id={3} /> It&apos;s an investment that pays for itself.<CitationRef id={4} />
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">🌱</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Reduce Carbon Footprint</h3>
              <p className="text-gray-600">
                Offset 3-4 tons of CO2 annually. Make a positive environmental impact for future generations.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">📋</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Federal Tax Credit</h3>
              <p className="text-gray-600">
                30% Federal Solar Tax Credit available through 2032.<CitationRef id={5} /> Plus Massachusetts state incentives.<CitationRef id={6} />
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">⚡</div>
              ...
              <p className="text-gray-600">
                Protect yourself from rising utility costs.<CitationRef id={7} /> Generate your own clean, reliable power.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Industry-leading warranties on panels and workmanship. Your investment is protected for decades.
              </p>
            </div>
          </div>
        </div>
