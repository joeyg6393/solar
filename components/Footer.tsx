        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Professional solar panel installation in Springfield, MA. NABCEP certified installers committed to quality and customer satisfaction.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-orange-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/#services" className="text-gray-400 hover:text-orange-500 transition-colors">Residential Solar</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-orange-500 transition-colors">Commercial Solar</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-orange-500 transition-colors">Battery Storage</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-orange-500 transition-colors">EV Chargers</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-orange-500 transition-colors">Maintenance & Repair</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>123 Solar Way<br />Springfield, MA 01101</span>
              </li>
